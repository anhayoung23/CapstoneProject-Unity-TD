...
> Unity + Syphon + TouchDesigner 기반 프로젝션 맵핑 인터랙티브 전시
...
1. [프로젝트 개요](#프로젝트-개요)
2. [시스템 구조](#시스템-구조)
3. [Unity 개발 과정](#unity-개발-과정)
4. [TouchDesigner 작업 과정](#touchdesigner-작업-과정)
5. [파일 구조](#파일-구조)
6. [주요 스크립트 설명](#주요-스크립트-설명)
